    ...
    function (a, b) {
          ...
          if (a)
            if ("number" == typeof a) c = [a >> 16, (a >> 8) & 255, 255 & a];
              ...
              if (("," === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), ma[a])) c = ma[a];
                ...
                } else (g = (Number(c[0]) % 360) / 360), (h = Number(c[1]) / 100), (i = Number(c[2]) / 100), (e = 0.5 >= i ? i * (h + 1) : i + h - i * h), (d = 2 * i - e), c.length > 3 && (c[3] = Number(c[3])), (c[0] = na(g + 1 / 3, d, e)), (c[1] = na(g, d, e)), (c[2] = na(g - 1 / 3, d, e));
      ...
      var Ba,
        ...
        La = (function () {
          ...
          return O.createElementNS && !d && ((a = Ja("svg", Ka)), (b = Ja("rect", a, { width: 100, height: 50, x: 100 })), (c = b.getBoundingClientRect().width), (b.style[Fa] = "50% 50%"), (b.style[Da] = "scaleX(0.5)"), (d = c === b.getBoundingClientRect().width && !(n && Ga)), Ka.removeChild(a)), d;
        })(),
        ...
        Ra = function (a, b) {
          var c,
            ...
            l = a.style;
          if (
            (Da ? (d = aa(a, Ea, null, !0)) : a.currentStyle && ((d = a.currentStyle.filter.match(G)), (d = d && 4 === d.length ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), j.x || 0, j.y || 0].join(",") : "")),
            (c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d),
            Da && c && !a.offsetParent && ((f = l.display), (l.display = "block"), (i = a.parentNode), (i && a.offsetParent) || ((g = 1), (h = a.nextSibling), Ka.appendChild(a)), (d = aa(a, Ea, null, !0)), (c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d), f ? (l.display = f) : Wa(l, "display"), g && (h ? i.insertBefore(a, h) : i ? i.appendChild(a) : Ka.removeChild(a))),
            (j.svg || (a.getCTM && Pa(a))) && (c && -1 !== (l[Da] + "").indexOf("matrix") && ((d = l[Da]), (c = 0)), (e = a.getAttribute("transform")), c && e && ((e = a.transform.baseVal.consolidate().matrix), (d = "matrix(" + e.a + "," + e.b + "," + e.c + "," + e.d + "," + e.e + "," + e.f + ")"), (c = 0))),
            c)
          )
            return Qa;
          ...
          if ((O && ((P += O), (B += O)), ((((1 === a || 0 === a) && "auto" === N && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime)) || !N) && !J && !M && !D && !C && 1 === G) || (Ba && L) || !Ga))
            return void (B || P || L
              ? ((B *= K),
                ...
                L && ((H += z.xOrigin - (z.xOrigin * c + z.yOrigin * d) + z.xOffset), (I += z.yOrigin - (z.xOrigin * f + z.yOrigin * g) + z.yOffset), Ba && (z.xPercent || z.yPercent) && ((q = this.t.getBBox()), (H += 0.01 * z.xPercent * q.width), (I += 0.01 * z.yPercent * q.height)), (q = 1e-6), q > H && H > -q && (H = 0), q > I && I > -q && (I = 0)),
        ...
        za("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
          parser: function (a, b, c, d, f, h, i) {
            ...
            return (
              ...
              C.svg && (D || z.svgOrigin) && ((p = C.xOffset), (s = C.yOffset), Ma(a, ia(D), k, z.svgOrigin, z.smoothOrigin), (f = va(C, "xOrigin", (v ? C : k).xOrigin, k.xOrigin, f, B)), (f = va(C, "yOrigin", (v ? C : k).yOrigin, k.yOrigin, f, B)), (p !== C.xOffset || s !== C.yOffset) && ((f = va(C, "xOffset", v ? p : C.xOffset, C.xOffset, f, B)), (f = va(C, "yOffset", v ? s : C.yOffset, C.yOffset, f, B))), (D = "0px 0px")),
              (D || (Ga && m && C.zOrigin)) && (Da ? ((n = !0), (u = Fa), D || ((D = (aa(a, u, e, !1, "50% 50%") + "").split(" ")), (D = D[0] + " " + D[1] + " " + C.zOrigin + "px")), (D += ""), (f = new ua(w, u, 0, 0, f, -1, B)), (f.b = w[u]), (f.plugin = h), Ga ? ((l = C.zOrigin), (D = D.split(" ")), (C.zOrigin = (D.length > 2 ? parseFloat(D[2]) : l) || 0), (f.xs0 = f.e = D[0] + " " + (D[1] || "50%") + " 0px"), (f = new ua(C, "zOrigin", 0, 0, f, -1, f.n)), (f.b = l), (f.xs0 = f.e = C.zOrigin)) : (f.xs0 = f.e = D)) : ia(D + "", C)),
              ...
              (m = aa(a, g, e) + ""),
                ...
                "color" === g || "fill" === g || "stroke" === g || -1 !== g.indexOf("Color") || (s && A.test(n))
                  ...
                  : ((j = parseFloat(m)),
                    ...
                    ("" === m || "auto" === m) && ("width" === g || "height" === g ? ((j = ha(a, g, e)), (o = "px")) : "left" === g || "top" === g ? ((j = ca(a, g, e)), (o = "px")) : ((j = "opacity" !== g ? 0 : 1), (o = ""))),
                    (t = s && "=" === n.charAt(1)),
                    t ? ((l = parseInt(n.charAt(0) + "1", 10)), (n = n.substr(2)), (l *= parseFloat(n)), (p = n.replace(w, ""))) : ((l = parseFloat(n)), (p = s ? n.replace(w, "") : "")),
                    "" === p && (p = g in d ? d[g] : o),
                    (n = l || 0 === l ? (t ? l + j : l) + p : b[g]),
                    o !== p && ("" !== p || "lineHeight" === g) && (l || 0 === l) && j && ((j = ba(a, g, j, o)), "%" === p ? ((j /= ba(a, g, 100, "%") / 100), b.strictUnits !== !0 && (m = j + "%")) : "em" === p || "rem" === p || "vw" === p || "vh" === p ? (j /= ba(a, g, 1, p)) : "px" !== p && ((l = ba(a, g, l, p)), (p = "px")), t && (l || 0 === l) && (n = l + j + p)),
                    t && (l += j),
                    (!j && 0 !== j) || (!l && 0 !== l) ? (void 0 !== u[g] && (n || (n + "" != "NaN" && null != n)) ? ((c = new ua(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n)), (c.xs0 = "none" !== n || ("display" !== g && -1 === g.indexOf("Style")) ? n : m)) : W("invalid " + g + " tween value: " + b[g])) : ((c = new ua(u, g, j, l - j, c, 0, g, k !== !1 && ("px" === p || "zIndex" === g), 0, m, n)), (c.xs0 = p)));
            }
...
// Debug Indicators TODO: more localize
